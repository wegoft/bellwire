...
enum BellwireTypography {
    ...
    static let technicalLabel = Font.system(.caption, design: .monospaced, weight: .medium)
    ...
    static let microLabel = Font.system(.caption, design: .monospaced, weight: .medium)
